...
export default function Dashboard() {
  ...
  useEffect(() => {
    try {
      ...
      // Si no contiene registros sembrados, sembramos de inmediato para consistencia total en dashboard
      ...
      if (!hasSeeded) {
        ...
        loaded = [...loaded.filter(r => r && !r.id.startsWith('seeded_')), ...seededRecords];
      }
