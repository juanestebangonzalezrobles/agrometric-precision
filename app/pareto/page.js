    ...
    <>
      ...
      <div className="page-content fade-in">
        ...
        {data && data.length > 0 ? (
            ...
            {(() => {
              ...
              return (
                <div className="chart-wrapper">
                  <div className="chart-title">Diagrama de Pareto — {producto || 'General'}</div>
          ...
          <div className="card text-center fade-in" style={{ padding: '48px 24px', textAlign: 'center', background: 'rgba(255, 255, 255, 0.01)', border: '1px dashed var(--border)', borderRadius: 12, marginBottom: 16 }}>
            <div style={{ fontSize: 48, marginBottom: 16 }}>📊</div>
            <h3 style={{ fontSize: 18, fontWeight: 800, color: 'var(--text-primary)', marginBottom: 8 }}>Esperando Datos de Defectos</h3>
            <p style={{ fontSize: 14, color: 'var(--text-muted)', maxWidth: 540, margin: '0 auto', lineHeight: 1.6 }}>
              Ingrese las categorías de defectos y sus frecuencias en la tabla superior, luego haga clic en <strong>Generar Pareto</strong> para identificar los problemas vitales (Regla 80/20) y obtener el diagnóstico automatizado.
            </p>
          </div>
        )}
      </div>
